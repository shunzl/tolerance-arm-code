...
; <label>:44:                                     ; preds = %43
  ...
  %47 = call arm_aapcscc i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), double %46)
  ret i32 0
}
...
; Function Attrs: nounwind
define arm_aapcscc float @injectfault(float) #0 {
  %2 = alloca float, align 4
  %3 = alloca i32, align 4
  store float %0, float* %2, align 4
  %4 = call arm_aapcscc i32 @time(i32* null)
  call arm_aapcscc void @srand(i32 %4)
  %5 = call arm_aapcscc i32 @rand()
  %6 = srem i32 %5, 10
...
declare arm_aapcscc void @srand(i32) #2

declare arm_aapcscc i32 @time(i32*) #2

declare arm_aapcscc i32 @rand() #2
