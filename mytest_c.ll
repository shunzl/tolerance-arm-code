...
define arm_aapcscc i32 @main() #0 {
  ...
  %Vop = add <4 x i32> %4, <i32 1, i32 1, i32 1, i32 1>
  store <4 x i32> %Vop, <4 x i32>* %allocaVec1
  %5 = add nsw i32 %3, 1
  store i32 %5, i32* %1, align 4
  %6 = load i32, i32* %1, align 4
  %7 = load <4 x i32>, <4 x i32>* %allocaVec1, align 16
  %Vop6 = add <4 x i32> %7, <i32 2, i32 2, i32 2, i32 2>
  store <4 x i32> %Vop6, <4 x i32>* %allocaVec2
  %8 = load <4 x i32>, <4 x i32>* %allocaVec2, align 4
  %extractE = extractelement <4 x i32> %8, i64 0
  %extractE7 = extractelement <4 x i32> %8, i64 1
  %extractE8 = extractelement <4 x i32> %8, i64 2
...
; <label>:14:                                     ; preds = %0, %13
  ...
  %17 = call arm_aapcscc i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %16)
  ret i32 0
}
