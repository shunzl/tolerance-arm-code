...
define arm_aapcscc i32 @main() local_unnamed_addr #0 {
  %1 = tail call <2 x i32> @llvm.arm.neon.vpadd.v2i32(<2 x i32> <i32 2, i32 2>, <2 x i32> <i32 2, i32 2>) #3
  %2 = extractelement <2 x i32> %1, i32 0
  %3 = tail call arm_aapcscc i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %2)
  ret i32 0
}

; Function Attrs: nounwind
declare arm_aapcscc i32 @printf(i8* nocapture readonly, ...) local_unnamed_addr #1

; Function Attrs: nounwind readnone
declare <2 x i32> @llvm.arm.neon.vpadd.v2i32(<2 x i32>, <2 x i32>) #2
